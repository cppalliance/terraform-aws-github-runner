...
"# choco install -y visualstudio2017buildtools --version 15.9.54.0 # why did this also get installed?",
...
"choco install -y visualstudio2022-workload-vctools --package-parameters \"--add icrosoft.VisualStudio.Component.VC.14.30.17.0.x86.x64\" ",
