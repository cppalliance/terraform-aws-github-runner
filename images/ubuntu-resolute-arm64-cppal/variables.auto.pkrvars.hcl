...
"DEBIAN_FRONTEND=noninteractive sudo apt-get -y install tzdata && sudo apt-get -o Acquire::Retries=3 install -y sudo software-properties-common wget curl apt-transport-https git make apt-file sudo unzip libssl-dev build-essential autotools-dev autoconf automake g++ g++-14 python3 python3-pip rsync ruby cpio pkgconf ccache locales cmake python-is-python3",
...
"sudo apt-get install -y clang-19 clang-20 clang-21 clang-22",
